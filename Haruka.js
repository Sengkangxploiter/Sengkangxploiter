...
require('./message/case.js')
nocache('./message/case.js', module => console.log(`${module} is now updated!`))

const starts = async (haruka = new WAConnection()) => {
    haruka.logger.level = 'warn'
    haruka.version = [2, 2143, 3]
    haruka.browserDescription = [ 'Lucifer-Bot', 'Chrome', '3.0' ]
	CFonts.say('botwa', {
		font: 'block',
    	color: ['#a6ff00'],
    	align: 'center',
		})
	CFonts.say(`© Created By Lucifer_Xrifan`, {
		font: 'console',
		align: 'center',
    ...
    haruka.on('chat-update', async (message) => {
        require('./message/case.js')(haruka, message)
    })
